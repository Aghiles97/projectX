                    ...
                    <div id="category_select_container">
                        <?php if (!empty($category)):
                            ...
                            foreach ($parent_array as $parent_id):
                                ...
                                if (!empty($parent_item)):
                                    ...
                                    if (!empty($subcategories)): ?>
                                        <select name="category_id[]" class="form-control subcategory-select custom-select<?= $level == 1 ? ' category-select-first' : ''; ?>" data-level="<?= $level; ?>" onchange="get_subcategories(this.value, '<?= $level; ?>');" <?= $level == 1 ? 'required' : ''; ?>>
                            ...
                            if (!empty($category)):
                                ...
                                if (!empty($subcategories)): ?>
                                    <select name="category_id[]" class="form-control subcategory-select custom-select" data-level="<?= $level; ?>" onchange="get_subcategories(this.value, '<?= $level; ?>');">
                                        <option value=""><?php echo trans('select_category'); ?></option>
                                        <?php foreach ($subcategories as $subcategory): ?>
                            ...
                            <select id="categories" name="category_id[]" class="form-control custom-select m-0" onchange="get_subcategories(this.value, 1);" required>
                                <option value=""><?php echo trans('select_category'); ?></option>
...
<script>
    function get_subcategories(parent_id, level) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (obj.result == 1 && obj.html_content != '') {
                    var select_tag = '<select class="form-control subcategory-select custom-select" data-level="' + new_level + '" name="category_id[]" onchange="get_subcategories(this.value,' + new_level + ');">' +
